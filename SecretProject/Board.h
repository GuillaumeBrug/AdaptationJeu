...
public:
	...
	L_HRESULT RegisterElement(ELEMENTTYPE iEltType, int iSubType, Player* ipPlayer, AREA iArea);
	
	L_HRESULT RegisterSuperElement(ELEMENTTYPE iEltType, int iSubType, Player* ipPlayer, AREA iArea, std::vector<int> iSubTypeSubElts);
